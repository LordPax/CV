						...
						<div class = "fen">
							...
							<p class = "fen_contenu">
								<div class = "logo l1">
									...
									<a class = "" href = "https://www.linkedin.com/in/teddy-gauthier-ab7082167/" target = "_blank"><img class = "logo_img git1" src ="images/Linkedin_logo_light.png"><img class = "logo_img git2" src ="images/Linkedin_logo_dark.png"></a>
								</div>
								<div class = "logo l2">
